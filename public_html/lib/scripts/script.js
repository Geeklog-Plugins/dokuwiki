...
function insitu_popup(target, popup_id) {
    ...
    if(!fndiv){
        ...
        dw_addEvent(fndiv,'mouseout',function(e){
...
addInitEvent(function(){
    ...
    for(var i=0; i<elems.length; i++){
        dw_addEvent(elems[i],'mouseover',function(e){footnote(e);});
    }
});
...
function initSizeCtl(ctlid,edid){
    ...
    dw_addEvent(l,'click',function(){sizeCtl(edid,100);});
    dw_addEvent(s,'click',function(){sizeCtl(edid,-100);});
    dw_addEvent(w,'click',function(){toggleWrap(edid);});
    ctl.appendChild(l);
    ctl.appendChild(s);
    ctl.appendChild(w);
}
...
addInitEvent(function(){
    ...
    for (var i=0; i<elems.length; i++) {
        ...
        if (input1.type=='checkbox') {
            dw_addEvent(input1,'click',function(e){
...
addInitEvent(function(){
    ...
    for(var i=0; i<selects.length; i++){
        ...
        dw_addEvent(selects[i],'change',function(e){
            this.form.submit();
        });
        // hide submit buttons
...
function checkWindowsShares() {
    ...
    if(elems){
        for(var i=0; i<elems.length; i++){
            var share = elems[i];
            dw_addEvent(share,'click',function(){
...
addInitEvent(function(){
    ...
    for(var i=0; i<btns.length; i++){
        dw_addEvent(btns[i],'mouseover',function(e){
        ...
        dw_addEvent(btns[i],'mouseout',function(e){
