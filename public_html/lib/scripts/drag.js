...
var drag = {
    ...
    attach: function (obj,handle) {
        ...
        var _this = this;
        dw_addEvent($(handle),'mousedown',function (e) {return _this.start(e); });
    },
    ...
    start: function (e){
        ...
        dw_addEvent(document,'mousemove', this.mousehandlers[0]);
        dw_addEvent(document,'mouseup', this.mousehandlers[1]);
